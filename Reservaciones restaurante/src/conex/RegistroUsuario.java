...
if (!validarContrasena(contrasena)) {
  ...
  private boolean validarNombre(String nombre) {
    ...
    if (nombre.length() < 3 || nombre.length() > 50) {
        JOptionPane.showMessageDialog(this, "El nombre debe tener entre 3 y 50 caracteres");
        return false;
    }
    return true;
}

// Validación del correo: formato válido y longitud máxima
private boolean validarCorreo(String correo) {
    ...
    if (correo.length() > 100) {
        JOptionPane.showMessageDialog(this, "El correo no puede tener más de 100 caracteres");
        return false;
    }
    return true;
}

// Validación del teléfono: solo números, entre 6 y 15 dígitos
private boolean validarTelefono(String telefono) {
    ...
    if (telefono.length() < 6 || telefono.length() > 15) {
        JOptionPane.showMessageDialog(this, "El teléfono debe tener entre 6 y 15 dígitos");
        return false;
    }
    return true;
}  
