...
CREATE TABLE `opiniones` (
  `id` int(254) NOT NULL COMMENT 'Identificador único (PK).',
  `estado` tinyint(253) NOT NULL,
...
INSERT INTO `opiniones` (`id`, `estado`, `fechaopinion`) VALUES
(1, 0, '0000-00-00'),
(2, 1, '0000-00-00'),
(3, 0, '0000-00-00'),
(4, 0, '0000-00-00'),
...
('arroz con pollo ', 'arroz', 22.00, 'General'),
('Ceviche peruano', 'Pescado marinado en limón fresco.', 30.00, 'General'),
('prueba platillo', 'prueba', 111.00, 'General'),
('pan con chicharron', 'chicharron frito con camote y pan', 20.00, 'General'),
('pan con lechon', 'pan y lechon', 20.00, 'General');
...
(86, 'Mesa P1', '2025-12-02', '02:00:00', 'admin', 2, 'sala principal', 'RSV-SIJ-4398', 'Plin', 'Pagado', 0, 49);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `reservas_eliminadas`
--

CREATE TABLE `reservas_eliminadas` (
  `id` int(100) NOT NULL,
  `mesa` varchar(150) NOT NULL,
  `fecha` date NOT NULL,
  ...
  `estacionamiento` int(50) NOT NULL,
  `precio` decimal(10,2) NOT NULL,
  `fecha_eliminacion` datetime(6) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `reservas_eliminadas`
--

INSERT INTO `reservas_eliminadas` (`id`, `mesa`, `fecha`, `hora`, `cliente`, `capacidad`, `sala`, `codigo_reserva`, `metodo_pago`, `estado_pago`, `estacionamiento`, `precio`, `fecha_eliminacion`) VALUES
(82, 'Mesa P10', '2025-11-26', '04:00:00.000000', 'admin', 1, 'sala principal', 'RSV-VMU-9804', 'Efectivo', 'Pendiente', 0, 40.00, '2025-11-26 02:53:09.000000'),
(83, 'Mesa P5', '2025-11-26', '01:00:00.000000', 'admin', 3, 'sala principal', 'RSV-TMD-4223', 'Tarjeta', 'Pagado', 0, 62.00, '2025-11-26 02:51:53.000000'),
(84, 'Mesa S6', '2025-11-26', '01:00:00.000000', 'admin', 2, 'sala secundaria', 'RSV-AFB-5558', 'Tarjeta', 'Pagado', 0, 52.00, '2025-12-02 01:15:23.000000');
...
(18, 'Terraza', 'Principal', 19),
(19, 'sala principal', 'Principal', 6),
(20, 'sala principal', 'Principal', 4);
...
INSERT INTO `usuarios` (`id`, `nombre_completo`, `correo`, `contrasena`, `rol`, `telefono`, `estado`) VALUES
(34, 'cliente prueba ', 'cliente@restaurante.com', 'Admin123-', 'cliente', '1111111', 1),
(35, 'admin', 'admin@restaurante.com', 'Admin123-', 'admin', '111', 0),
(36, 'Admin de Prueba', 'admin.seed@restaurante.com', 'Admin123*', 'admin', '999888777', 1),
(37, 'Cliente de Prueba', 'cliente.seed@restaurante.com', 'Cliente456-', 'cliente', '911222333', 1);
...
--
-- Indices de la tabla `reservas_eliminadas`
--
ALTER TABLE `reservas_eliminadas`
  ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `opiniones`
  MODIFY `id` int(254) NOT NULL AUTO_INCREMENT COMMENT 'Identificador único (PK).', AUTO_INCREMENT=21;
...
--
-- AUTO_INCREMENT de la tabla `reservas_eliminadas`
--
ALTER TABLE `reservas_eliminadas`
