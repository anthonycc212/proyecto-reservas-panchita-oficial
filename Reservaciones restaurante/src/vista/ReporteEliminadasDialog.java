 ...
 * @author antho
 */
public class ReporteEliminadasDialog extends JDialog {

private JTextArea textAreaReporte;

    public ReporteEliminadasDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    ...
    private void generarReporte() {
        ...
        reporte.append("==================================================\n");
        reporte.append("         HISTORIAL DE RESERVAS ELIMINADAS\n");
        reporte.append("==================================================\n\n");
        ...
        try {
            ...
            while (rs.next()) {
                ...
                reporte.append(String.format("Fecha Eliminación: %s\n", rs.getString("fecha_eliminacion")));
